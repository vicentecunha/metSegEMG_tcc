...
% Node placement
%------------------------------------------------------------------------------
			\node[io](x1){}; \node[left=of x1](x1in){$x_1$};
			\node[io, below=of x1](x2){}; \node[left=of x2](x2in){$x_2$};
			\node[io, below=of x2](x3){}; \node[left=of x3](x3in){$x_3$};
			\node[below=of x3, yshift=2em]{...};
			\node[io, below=of x3](x4){}; \node[left=of x4](x4in){$x_m$};
			...
			\node[right=of nt1](y1){$y_1$};
			\node[right=of nt2](y2){$y_2$};
			\node[right=of nt3](y3){$y_n$};
