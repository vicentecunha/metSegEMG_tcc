\begin{sidewaystable}[htb]
	...
	\IBGEtab{\caption{ \label{tab:num_mtd1_ninapro} Número médio de segmentos obtidos para todos os voluntários com diferentes combinações de parâmetros. Base de dados: NinaPro. Método: MTD1.}}
	{
